...
import { LayoutDashboard, Users, BarChart3, FileText, Settings, MessageSquare, CreditCard } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "Query AI", href: "/officer/query", icon: MessageSquare },
    ...
    >
      ...
      >
        <Link
          ...
          onMouseLeave={(e) => {
            e.currentTarget.style.color = "var(--th-text-faint)";
          }}
        >
          ← Student portal
        </Link>
