  ...
  return (
    <div className="relative w-32 h-32 flex items-center justify-center mx-auto">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <span className="text-2xl font-black text-[var(--th-text-primary)] font-mono leading-none">{value}%</span>
...
export default function ATSAnalyzerPage() {
  ...
  const handleStartAnalysis = () => {
    ...
    try {
      const res = api.post('resume/analyze')
    } catch (err) {
      console.log("err", err)
    }
    setAnalyzing(true);
  ...
  return (
    <div className="min-h-screen pb-16" style={{ backgroundColor: "var(--th-bg)", fontFamily: "var(--font-inter), sans-serif" }}>
      <Navbar mode="intelligence" />

      {/* Main Grid Workspace - 3 Column Layout stretched to max-w-7xl */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 space-y-6">
        ...
        <div className="flex items-center justify-between gap-4 flex-wrap pb-4 border-b border-dashed" style={{ borderColor: "var(--th-border)" }}>
          <div>
            <p className="label-caption mb-1" style={{ color: "var(--th-text-faint)" }}>Interactive ATS Sandbox</p>
            <h1 className="text-xl md:text-2xl font-black tracking-tight" style={{ color: "var(--th-text-primary)" }}>
              Real-time Resume Builder & AI Advisor
            </h1>
          </div>
              ...
              {analyzed && !analyzing && (
                <div className="space-y-4">
                  ...
                  <div className="text-left pt-2">
                    <h4 className="text-[10px] uppercase font-bold tracking-wider mb-3 text-[var(--th-text-faint)]">
                          ...
                          <div
                            ...
                            className={cn(
                              ...
                              isApplied
                                ...
                                : "bg-[var(--th-bg-secondary)] border-[var(--th-border)]"
                            )}
                          >
                            <div className="flex items-start justify-between gap-1">
                              <span className="text-[9px] font-mono font-bold uppercase text-[var(--th-text-faint)]">
                                {sug.expId ? "Phrasing Optimize" : "Keywords Check"}
                              </span>
                              {isApplied && (
                            ...
                            <div className="space-y-1">
                              {!isApplied && (
                                <p className="text-[10px] line-through leading-normal" style={{ color: "var(--th-text-muted)" }}>
                                  &quot;{sug.original}&quot;
                                </p>
                              )}
                              <p className="text-[10.5px] font-bold leading-normal text-blue-600 dark:text-blue-400">
                                &quot;{sug.suggested}&quot;
                              </p>
                            </div>

                            <p className="text-[9px] leading-relaxed opacity-70" style={{ color: "var(--th-text-secondary)" }}>
                              {sug.reason}
                            </p>
                            ...
                            {!isApplied && (
                              <button
                                ...
                                className="w-full py-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-[10px] font-black uppercase tracking-wider transition-colors cursor-pointer border-none"
                              >
                                Apply AI Phrasing
                              </button>
                            )}
          ...
          >
            ...
            <div className="flex items-center justify-between border-b pb-4" style={{ borderColor: "var(--th-border)" }}>
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-sm font-black" style={{ color: "var(--th-text-primary)" }}>Job Description Match</h3>
            ...
            <div className="flex gap-3 pt-1">
              ...
              <button
                ...
                className="flex-1 py-2.5 rounded-xl text-xs font-black uppercase tracking-wider bg-blue-600 hover:bg-blue-700 text-white transition-colors cursor-pointer border-none disabled:opacity-40 disabled:cursor-not-allowed"
              >
