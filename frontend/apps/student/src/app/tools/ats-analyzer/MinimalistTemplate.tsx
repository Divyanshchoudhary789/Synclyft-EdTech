...
export function MinimalistTemplate({
  ...
  return (
    <div className="font-serif leading-relaxed text-xs">
      {/* Header */}
      <div className={cn("text-center border-b pb-4 mb-4", getHeaderColor())}>
        <h2 className="text-xl font-bold uppercase tracking-wide mb-1">
          {profile.name}
        </h2>
        <div className={cn("flex flex-wrap justify-center gap-x-2 gap-y-0.5 text-[9px]", getSubTextColor())}>
      ...
      {/* Loop through custom sectionsOrder dynamically */}
